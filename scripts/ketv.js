...
function main() {
    if (Mjztool.matchURL("/play/")) {
        

        Mjztool.addStyle(".hot_banner{z-index: -1; height: 12px !important;} .hot_banner:hover{z-index: 1;}");

        document.querySelector('.play_share').remove();
