...
function main() {
    Mjztool.addStyle("body{background-color: #1c1b1e !important;}");
    Mjztool.addStyle("header{margin: 4px !important; } ");
    Mjztool.addStyle("header, .stui-player__detail{opacity: 10%;}");
    Mjztool.addStyle("header:hover, .stui-player__detail:hover{opacity: 100% !important;}");
